from data_cleate import name_data, surname_data, phone_data, address_data
...
def input_data():
    ...
    while var != 1 and var != 2:
        print('Не верно введен номер варианта, попробуйте ещё раз')
    ...
    if var == 1:
        ...
        with open('data_second_variant.csv', 'a', encoding='utf-8') as file:
            file.write(f'{name};{surname};{address}\n\n')
...
def put_data():
    ...
    while number_file != 1 and number_file != 2:
        print ('Не верно веден номер файла, попробуйте ещё раз: ')
        number_file = int(input('Введите номер файла: '))
